...
function checkWinningCondition(currentBoard) {
    ...
    for (i = 0; i <= 6; i += 3) {
        if (currentBoard[i] === KUCING && currentBoard[i + 1] === KUCING && currentBoard[i + 2] === KUCING)
            return 2;
        if (currentBoard[i] === ANJING && currentBoard[i + 1] === ANJING && currentBoard[i + 2] === ANJING)
            return 3;
    }

    // Check for vertical wins
    for (i = 0; i <= 2; i++) {
        if (currentBoard[i] === KUCING && currentBoard[i + 3] === KUCING && currentBoard[i + 6] === KUCING)
            return 2;
        if (currentBoard[i] === ANJING && currentBoard[i + 3] === ANJING && currentBoard[i + 6] === ANJING)
            return 3;
    }

    // Check for diagonal wins
    if ((currentBoard[0] === KUCING && currentBoard[4] === KUCING && currentBoard[8] === KUCING) ||
        (currentBoard[2] === KUCING && currentBoard[4] === KUCING && currentBoard[6] === KUCING))
        return 2;

    if ((currentBoard[0] === ANJING && currentBoard[4] === ANJING && currentBoard[8] === ANJING) ||
        (currentBoard[2] === ANJING && currentBoard[4] === ANJING && currentBoard[6] === ANJING))
        return 3;
