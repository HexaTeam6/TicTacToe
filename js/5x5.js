...
function checkWinningCondition(currentBoard) {
    ...
    for (i = 0; i <= 20; i += 5) {
        if (currentBoard[i] === KUCING && currentBoard[i + 1] === KUCING && currentBoard[i + 2] === KUCING && currentBoard[i + 3] === KUCING && currentBoard[i + 4] === KUCING)
            return 2;
        if (currentBoard[i] === ANJING && currentBoard[i + 1] === ANJING && currentBoard[i + 2] === ANJING && currentBoard[i + 3] === ANJING && currentBoard[i + 4] === ANJING)
            return 3;
    }

    // Check for vertical wins
    for (i = 0; i <= 4; i++) {
        if (currentBoard[i] === KUCING && currentBoard[i + 5] === KUCING && currentBoard[i + 10] === KUCING && currentBoard[i + 15] === KUCING && currentBoard[i + 20] === KUCING)
            return 2;
        if (currentBoard[i] === ANJING && currentBoard[i + 5] === ANJING && currentBoard[i + 10] === ANJING && currentBoard[i + 15] === ANJING && currentBoard[i + 20] === ANJING)
            return 3;
    }

    // Check for diagonal wins
    if ((currentBoard[0] === KUCING && currentBoard[6] === KUCING && currentBoard[12] === KUCING && currentBoard[18] === KUCING && currentBoard[24] === KUCING) ||
        (currentBoard[4] === KUCING && currentBoard[8] === KUCING && currentBoard[12] === KUCING && currentBoard[16] === KUCING && currentBoard[20] === KUCING))
        return 2;

    if ((currentBoard[0] === ANJING && currentBoard[6] === ANJING && currentBoard[12] === ANJING && currentBoard[18] === ANJING && currentBoard[24] === ANJING) ||
        (currentBoard[4] === ANJING && currentBoard[8] === ANJING && currentBoard[12] === ANJING && currentBoard[16] === ANJING && currentBoard[20] === ANJING))
        return 3;
